...
inputs = glob("/home/vanessa/Documents/Work/BRAINMETA/IMAGE_COMPARISON/analysis/masking_scores/*.pkl")
...
for i in inputs:
  ...
  input_id = int(i.replace("/home/vanessa/Documents/Work/BRAINMETA/IMAGE_COMPARISON/analysis/masking_scores/000","").replace("_masking_scores.pkl",""))
...
pd_vs_bm.to_csv("144_pd_vs_bm_sizediff.tsv",sep="\t")
pi_vs_bm.to_csv("144_pi_vs_bm_sizediff.tsv",sep="\t")
pd_vs_pi.to_csv("144_pd_vs_pi_sizediff.tsv",sep="\t")
